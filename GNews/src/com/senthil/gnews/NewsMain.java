...
public class NewsMain extends Activity {
    ...
    public class DownloadXmlTask extends AsyncTask<String, Void, List<Entry>> {
        ...
        private List<Entry> loadXmlFromNetwork(String urlString) throws XmlPullParserException, IOException {
            ...
            htmlString.append("<h3>" + this.activityContext.getResources().getString(R.string.page_title) + "</h3>");
            htmlString.append("<em>" + this.activityContext.getResources().getString(R.string.updated) + " " +
